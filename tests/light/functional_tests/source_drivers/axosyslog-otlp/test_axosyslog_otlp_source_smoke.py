...
# @pytest.mark.parametrize("option_and_value", generate_options_and_values_for_driver("source", "axosyslog-otlp"), ids=generate_id_name)
# def test_axosyslog_otlp_source_smoke(config, syslog_ng, option_and_value):

...
OpenTelemetry, Google BigQuery, Google Pub/Sub, Grafana Loki and ClickHouse.
...
%{_libdir}/syslog-ng/libpubsub.so
...
%changelog
* Mon Jan 13 2025 unknown user <noemail@set.any.where> - 4.99.0-1
- updated to 4.99.0

* Mon Nov 11 2024 github-actions <41898282+github-actions@users.noreply.github.com> - 4.9.0-1
- updated to 4.9.0
